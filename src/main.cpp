...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    {
        nSubsidy = 150000 * COIN; // 1% Premine
    }
		else if(pindexBest->nHeight < 250)
    {
		nSubsidy = 1 * COIN; // low onyx reward to prevent instamine
    }
		else if(pindexBest->nHeight < 1500000)
    {
		nSubsidy = 10 * COIN; // long pow phase of 2.8 years with hybrid pos
    }
